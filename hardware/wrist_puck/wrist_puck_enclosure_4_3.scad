...
//  Rev 1.3  |  June 2026  |  Sean (Whitehorse, YT)
//
//  76mm diameter. All component positions geometry-validated
//  by Python solver before this file was written.
//
//  Rev 1.3 changes (from Rev 1.2):
//    - PUCK_H: 24mm → 30mm (+6mm)
//        Interior height grows from 20.2mm to 26.2mm.
//        Rail slot (12mm) now has 6.2mm headroom to shell top
//        rather than 0.2mm — enough for snap engagement and
//        linkage arm clearance above the sliding mass.
//    - SERVO_D: corrected base dim 25.0 → 25.1mm (was 0.1mm
//        under the SG51R spec; total Y clearance now 0.4mm)
//
//  RENDER control:
...
module bottom_shell() {
    difference() {
        ...
        // Interior void — starts above pocket zone so component wells have walls
        translate([0, 0, FLOOR_T + POCKET_H])
        ...
        // Battery pocket — extends past POCKET_H ceiling so it opens
        // into the interior void above (wires can exit upward, pocket visible)
